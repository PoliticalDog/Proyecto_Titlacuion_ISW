...
class GUIInicio:
    def __init__(self, master):
        ...
        self.btn_login = tk.Button(master, text="Ingresar", font=("Arial", 12), command=self.open_login_window)
    ...
    def about(self):
        messagebox.showinfo("Acerca del sistema", "Recuerda que para acceder es importante que tengas un registro previo, prueba el boton 'Ingresar' o si ya cuentas con una cuenta da click en 'Acceder'. Puedes comunicarte al tel: 55 5462 6374")
...
class VentanaAcceso:
    ...
    def validar_acceso(self):
        ...
        # Por ejemplo, puedes verificar contra datos en una base de datos aquí
